...
class MainActivity : AppCompatActivity() {
    ...
    private val winingPos = arrayOf(intArrayOf(0,1,2),intArrayOf(3,4,5),
        intArrayOf(6,7,8),intArrayOf(0,3,6),
        intArrayOf(1,4,7),intArrayOf(2,5,8),
        intArrayOf(0,4,8),intArrayOf(2,4,6))

    private var rounds = 0
    private val btnDfltCol = Color.rgb(28, 56, 93)
    private val btnCgdtCol = Color.rgb(218, 224, 224)
